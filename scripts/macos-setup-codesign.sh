...
# Create `gdb_codesign` certificate in MacOS keychain.
#
# https://sourceware.org/gdb/wiki/PermissionsDarwin
#
# Downloaded from https://raw.githubusercontent.com/conda-forge/gdb-feedstock/master/recipe/macos-codesign/macos-setup-codesign.sh
